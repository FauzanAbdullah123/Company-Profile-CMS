...
@section('title-website') Logo @endsection
@section('title') <h1 style="margin-left: 2%; margin-top: 15px; font-size: 35px;"><b>Logo</b></h1> @endsection
...
<script>
    ...
    columns:[
        {
            ...
            return "<img src={{ URL::to('/') }}/assets/img/logo/" + data + " width='70' class='img-thumbnail' />";
            },
            orderable: false
        },
        {
    ...
    $('#form_result').html('');
    $.ajax({
        url:"/backend/logo/"+id+"/edit",
        dataType:"json",
            success:function(html){
                $('#store_image').html("<img src={{ URL::to('/') }}/assets/img/logo/" + html.data.image + " width='70' class='img-thumbnail' />");
    ...
    $('#ok_button').click(function(){
        $.ajax({
        url:"/backend/logo/destroy/"+user_id,
        beforeSend:function(){
