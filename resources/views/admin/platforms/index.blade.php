 ...
 <div class="modal-dialog">
  <div class="modal-content">
   <div class="modal-header">
          ...
          <h4 class="modal-title">Add Data platforms</h4>
        </div>
        <div class="modal-body">
         ...
         <form method="post" id="sample_form" class="form-horizontal" enctype="multipart/form-data">
          ...
          <div class="form-group row mb-4">
            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3" >Platforms : </label>
            <div class="col-sm-12 col-md-10">
             <input type="text" name="platforms" id="platforms" class="form-control" />
            </div>
           </div>
            <div class="form-group row mb-4">
...
<script>
    ...
    $('.modal-title').text("Add Data Platforms");
    ...
    if($('#action').val() == 'Add')
    {
        ...
        if($('#action').val() == "Edit")
        {
            $.ajax({
                ...
                {
                Swal.fire(
                    'Data Platforms Successfully Edited!',
                    data.success,
                    'success'
                    )
                    location.reload();
    ...
    $.ajax({
        ...
        dataType:"json",
            success:function(html){
                ...
                $('#percentage').val(html.data.percentage);
                $('#title').val(html.data.title);
                $('#hidden_id').val(html.data.id);
                $('.modal-title').text("Edit Data Platforms");
                $('#action_button').val("Save");
                $('#action').val("Edit");
                $('#formModal').modal('show');
            }
