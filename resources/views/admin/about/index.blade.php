...
@section('title-website') About @endsection
@section('title') <h1 style="margin-left: 2%; margin-top: 15px; font-size: 35px;"><b>About</b></h1> @endsection
    ...
    if($('#action').val() == 'Add')
    {
        ...
        if($('#action').val() == "Edit")
        {
            $.ajax({
                ...
                {
                Swal.fire(
                    'Data About Successfully Edited!',
                    data.success,
                    'success'
                    )
                    location.reload();
