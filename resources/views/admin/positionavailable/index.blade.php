...
@include('admin.positionavailable.delete')
...
<section class="content">
    <div class="row">
        <div class="col-xs-12">
            ...
            <tr>
                <td>&nbsp &nbsp</td>
                <form action="{{ route('positionavailable.index') }}">
                    ...
                    <table id="" class="table table-bordered table-hover">
                        ...
                        @foreach ($positionavailable as $data)
                            <tr>
                                ...
                                <td align="right">
                                    <a href="{{route('positionavailable.edit', $data->id)}}">
                                    <button type="button" id="edit-data" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></button>
                                    </a>
                                </td>
                                <td>
                                    <button type="button" id="hapus-data" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapus"
                                            data-id="{{ $data->id }}" 
                                            data-judul="{{ $data->title }}"><i class="fa fa-trash-o"></i>
                                    </button>
                                </td>
                            </tr>
                            @endforeach
