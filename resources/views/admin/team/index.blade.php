...
@section('title-website') Team @endsection
@section('title') <h1 style="margin-left: 2%; margin-top: 15px; font-size: 35px;"><b>Team</b></h1> @endsection
 ...
 <div class="modal-dialog">
  <div class="modal-content">
   <div class="modal-header">
          ...
          <h4 class="modal-title">Add Data team</h4>
        </div>
...
<script>
    ...
    columns:[
        ...
        },
        {
            ...
            return "<img src={{ URL::to('/') }}/assets/img/team/" + data + " width='70' class='img-thumbnail' />";
            },
            orderable: false
        },
        {
    ...
    $('.modal-title').text("Add Data Team");
    ...
    $('#form_result').html('');
    $.ajax({
        url:"/backend/team/"+id+"/edit",
        dataType:"json",
            success:function(html){
                $('#store_image').html("<img src={{ URL::to('/') }}/assets/img/team/" + html.data.image + " width='70' class='img-thumbnail' />");
                $('#store_image').append("<input type='hidden' name='hidden_image' value='"+html.data.image+"' />");
                $('#title').val(html.data.title);
                $('#desc').val(html.data.desc);
                $('#hidden_id').val(html.data.id);
                $('.modal-title').text("Edit Data Team");
                $('#action_button').val("Save");
                $('#action').val("Edit");
                $('#formModal').modal('show');
            }
    ...
    $('#ok_button').click(function(){
        $.ajax({
        url:"/backend/team/destroy/"+user_id,
        beforeSend:function(){
