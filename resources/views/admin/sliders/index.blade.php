...
@section('title-website') Sliders @endsection
@section('title') <h1 style="margin-left: 2%; margin-top: 15px; font-size: 35px;"><b>Sliders</b></h1> @endsection
 ...
 <div class="modal-dialog">
  <div class="modal-content">
   <div class="modal-header">
          ...
          <h4 class="modal-title">Add Data sliders</h4>
        </div>
...
<script>
    ...
    columns:[
        ...
        },
        {
            ...
            return "<img src={{ URL::to('/') }}/assets/img/sliders/" + data + " width='70' class='img-thumbnail' />";
            },
            orderable: false
        },
        {
    ...
    $('.modal-title').text("Add Data Sliders");
    ...
    if($('#action').val() == 'Add')
    {
        ...
        if($('#action').val() == "Edit")
        {
            $.ajax({
                ...
                {
                Swal.fire(
                    'Data Sliders Successfully Edited!',
                    data.success,
                    'success'
                    )
                    location.reload();
    ...
    $('#form_result').html('');
    $.ajax({
        url:"/backend/sliders/"+id+"/edit",
        dataType:"json",
            success:function(html){
                $('#store_image').html("<img src={{ URL::to('/') }}/assets/img/sliders/" + html.data.image + " width='70' class='img-thumbnail' />");
                $('#store_image').append("<input type='hidden' name='hidden_image' value='"+html.data.image+"' />");
                $('#title').val(html.data.title);
                $('#desc').val(html.data.desc);
                $('#hidden_id').val(html.data.id);
                $('.modal-title').text("Edit Data Sliders");
                $('#action_button').val("Save");
                $('#action').val("Edit");
                $('#formModal').modal('show');
            }
    ...
    $('#ok_button').click(function(){
        $.ajax({
        url:"/backend/sliders/destroy/"+user_id,
        beforeSend:function(){
