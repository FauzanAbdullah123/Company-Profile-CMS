...
<div class="container_full">
	...
	<div class="header_text">
		<div class="container_12" style="height: 35px;">
    <iframe scrolling="no" frameborder="no" clocktype="html5" style="overflow:hidden;border:0;width:240px;height:25px;padding-top:5px;"src="https://www.clocklink.com/html5embed.php?clock=018&timezone=JOG&color=gray&size=240&Title=&Message=&Target=&From=2019,1,1,0,0,0&DateFormat=yyyy / mm / dd DDD&TimeFormat=hh:mm:ss TT&Color=gray"></iframe>
			<div class="grid_9">
				<h3>Home Page</h3>
			</div>
		</div>
        ...
        <div class="grid_3 alpha">
            <!-- a feature box -->
					<div class="feature_box">
						<div class="feature_icon"><a href="{{ route('detail.otherservice', $data->slug) }}"><img src="{{ asset('assets/img/otherservice/'.$data->image)}}" width="35px" height="35px" alt=""></a>
						</div>
						...
						<div class="feature_link"><a href="{{ route('detail.otherservice', $data->slug) }}" class="arrows_icons16 icon16_5 tooltip_s" title="Read More"></a></div>
					</div>
					<!-- a feature box end -->
				</div>
        @endforeach
